...
#include "libcef/browser/ui/views/desktop_capture/desktop_media_list_view.h"
...
#include "libcef/browser/media/webrtc/window_icon_util.h"
...
Cef::DesktopMediaSourceView* AsDesktopMediaSourceView(views::View* view) {
  DCHECK_EQ(Cef::DesktopMediaSourceView::kDesktopMediaSourceViewClassName,
            view->GetClassName());
  return static_cast<Cef::DesktopMediaSourceView*>(view);
}

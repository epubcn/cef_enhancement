...
//#include "libcef/browser/media/webrtc/desktop_media_list_ash.h"
#include "libcef/browser/media/webrtc/native_desktop_media_list.h"
//#include "libcef/browser/media/webrtc/tab_desktop_media_list.h"
...
// builds.
  ...
  return Cef::DesktopMediaPicker::Create();
#else
  return nullptr;
#endif
}
  ...
  for (auto source_type : types) {
    switch (source_type) {
      ...
      case content::DesktopMediaID::TYPE_SCREEN: {
        ...
        screen_list = std::make_unique<Cef::NativeDesktopMediaList>(
            content::DesktopMediaID::TYPE_SCREEN,
...
#else   // !defined(OS_CHROMEOS)
        window_list = std::make_unique<Cef::NativeDesktopMediaList>(
            content::DesktopMediaID::TYPE_WINDOW,

...
#include "libcef/browser/ui/views/desktop_capture/desktop_media_list_controller.h"
...
class DesktopMediaPickerDialogView : public views::DialogDelegateView,
 ...
 public:
  DesktopMediaPickerDialogView(
      const Cef::DesktopMediaPicker::Params& params,
      DesktopMediaPickerViews* parent,
      std::vector<std::unique_ptr<Cef::DesktopMediaList>> source_lists);
...
class DesktopMediaPickerViews : public Cef::DesktopMediaPicker {
 public:
  ...
  // DesktopMediaPicker:
  void Show(const Cef::DesktopMediaPicker::Params& params,

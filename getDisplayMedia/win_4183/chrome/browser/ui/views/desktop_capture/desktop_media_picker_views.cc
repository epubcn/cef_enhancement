...
DesktopMediaPickerDialogView::DesktopMediaPickerDialogView(
  ...
  bool modal_dialog = params.web_contents &&
                      !params.web_contents->GetDelegate()->IsNeverComposited(
                          params.web_contents);
  if (modal_dialog && !params.use_separated_modal_dialog) {
    widget =
  ...
  if(widget && params.always_on_top) {
...
#else
  bool is_separate_native_window = !modal_dialog || params.use_separated_window;
#endif
